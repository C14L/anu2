...
ANUNCIOS_POST_CATEGORIES = [
{
    'slug': 'gente',
    'old': None,
    'parent': None,
    'title': 'Gente',
    'descr': ('Anuncios para encontrar nuevos amigos. Encontrar pareja o '
              'alguien con quién chatear. Reencontrar viejos amigos de la '
              'escuelas que perdiste de vista.'),
}, {
    ...
    'descr': 'Anuncios para encontrar personas para una relación íntima.',
    'is_nsfw': True,
}, {
    ...
    'descr': 'Si lo vendes por dinero, esta es la sección para tu anuncio.',
    'is_nsfw': True,
}, {
    'slug': 're-encuentros',
    'old': 'hg',
    'parent': 'gente',
    'title': 'Re-encuentros',
    'descr': ('Si perdiste de vista a viejos amigos de la escuela, aquí '
              'puedes poner un anuncio de búsqueda.'),
}, {
...
###############################################################################
{
    ...
    'descr': ('Ofertas de trabajo del area de compra y venta de productos y '
               'servicios.'),
}, {
    ...
    'descr': ('Buscas un contador o tienes vacantes en el area de ',
              'contabilidad, entonces publica tu oferta de empleo aquí sin '
              'costo.'),
}, {
    ...
    'parent': 'empleo',
    'title': 'Téchnico',
    'descr': ('Empleos del area técnico, construcción, electricidad, coches, '
              'y otros.'),
}, {
    'slug': 'ingenieria',
    'old': 'eg',
    'parent': 'empleo',
    'title': 'Ingeniería',
    'descr': ('Ofertas de trabajo para personas graduados en un area de '
              'ingeniería.'),
}, {
    ...
    'parent': 'empleo',
    'title': 'Turismo',
    'descr': 'Ofertas de trabajo en cualquier ramo del area turístico.',
}, {
    'slug': 'publicidad-y-mercadotecnia',
    'old': 'ek',
    'parent': 'empleo',
    'title': 'Publicidad y Mercadotécnia',
    'descr': ('Empleos del area de la mercadotecnia y todo relacionado a la '
              'publicidad.'),
}, {
    'slug': 'educacion',
    'old': 'el',
    ...
    'parent': 'empleo',
    'title': 'Otros empleos',
    'descr': ('Cualquier otra oferta de empleo que no queda en ninguna de las '
              'areas arriba mencionadas.'),
}, {
    'slug': 'solicitudes-de-empleo',
    'old': 'eo',
    'parent': 'empleo',
    'title': 'Solicitudes de Empleo',
    'descr': ('Si estás buscando trabajo, puedes publicar aquí tu solicitud '
              'y un breve resumen de tu C.V. Recuerda: NO datos personales!'),
},
###############################################################################
{
    'slug': 'vivienda',
    ...
    'descr': ('Si quieres vender tu casa o estas buscando comprar una casa, '
              'publica aquí tu anuncio.'),
}, {
    'slug': 'vender-comprar-departamento',
    'old': 'cb',
    'parent': 'vivienda',
    'title': 'Venta y compra de departamentos',
    'descr': ('Si quieres cender o comprar un departamento, publica tu '
              'anuncio gratis aquí.'),
}, {
    'slug': 'rentar-casa',
    'old': 'cc',
    ...
    'descr': ('Si tienes o buscas un departamento para rentar, aquí puedes '
              'publicar tu anuncio.'),
}, {
    ...
    'descr': 'Renta o venta de locales comerciales y espacios de oficina.',
}, {
    'slug': 'para-estudiantes',
    'old': 'cf',
    'parent': 'vivienda',
    'title': 'Para Estudiantes',
    'descr': 'Renta de departamentos o habitaciones para estudiantes.',
},
###############################################################################
{
    ...
    'descr': ('Anuncios de venta y compra de coches, camionetas, motos, '
              'bicicletas, y mas.'),
}, {
    'slug': 'computadoras',
    'old': 'vb',
    ...
    'parent': 'vender',
    'title': 'Electrónicos',
    'descr': ('Comprar y vender televosores, radios, tocadores de discos '
              'compactos, y mas.'),
}, {
    ...
    'descr': ('Comprar y vender refris, lavadoras, lavatrastes, y otros '
              'electrodomésticos.'),
}, {
    ...
    'descr': ('Comprar y vender celulares y accesorios para celular. También '
              'contratos y tarjetas para celular.'),
}, {
    'slug': 'muebles',
    'old': 'vf',
    'parent': 'vender',
    'title': 'Muebles',
    'descr': ('Comprar y vender muebles, sillas, sillones, armarios, mesas '
              'y mas.'),
}, {
    'slug': 'deportes',
    'old': 'vg',
    'parent': 'vender',
    'title': 'Deportes',
    'descr': 'Venta y compra de accesorios y aparatos para deportes.',
}, {
    'slug': 'Ropa',
    'old': 'vh',
    'parent': 'vender',
    ...
    'descr': 'Comprar, vender e intercambiar cualquier cosas coleccionable.',
}, {
    'slug': 'otras',
    'old': 'vk',
    'parent': 'vender',
    'title': 'Otras compras y ventas',
    'descr': ('Venta y compra de otras cosas que no caben en una de las '
    ...
    'parent': 'vender',
    'title': 'Gratis',
    'descr': 'Ofrece o busca cosas gratis. Regala lo que ya no utilizas.',
},
###############################################################################
{
    'slug': 'servicios',
    ...
    'parent': 'servicio',
    'title': 'Hogar',
    'descr': ('Ofrece o busca servicios de jardinero, sirvienta, cocinero '
              'y otros.'),
}, {
    'slug': 'traducciones',
    'old': 'sb',
    'parent': 'servicio',
    'title': 'Traducciones',
    'descr': ('Ofrece o busca servicios de traducción de textos al Español, '
              'o del Español a otro idioma.'),
}, {
    'slug': 'mudanzas',
    'old': 'sc',
    'parent': 'servicio',
    ...
    'descr': ('Encuentra u ofrece servicios de conección a Internet, Café '
              'de Internet, o reparación de computadoras.'),
}, {
...
###############################################################################
{
    ...
    'parent': 'clases',
    'title': 'Idiomas',
    'descr': ('Talleres y clases para aprender idiomas como el Inglés, '
              'Francés, Alemán, Japonés, y otros.'),
}, {
    'slug': 'computacion',
    'old': 'tb',
    'parent': 'clases',
